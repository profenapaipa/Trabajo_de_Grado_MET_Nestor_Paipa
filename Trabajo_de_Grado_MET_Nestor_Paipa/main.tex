...
El núcleo de procesamiento de cada cubo es ESP32 con 
Bluetooth para recibir comunicarse con el \textit{Master}. Los periféricos de salida
...
frecuencia y duración controladas programáticamente. La alimentación del
...
un microcontrolador de mayor capacidad de procesamiento que los cubos
individuales [\textbf{modelo base, p.ej. Raspberry Pi Zero o ESP32 con
mayor RAM}], al que se conectan un módulo de comunicación inalámbrica
hacia los cubos y otro módulo de conexión hacia el dispositivo del
docente (computadora portátil o tableta con la interfaz de control). La
...
El hardware de la base incluye un módulo \textbf{[protocolo de
comunicación: Bluetooth Low Energy, WiFi o ZigBee]} configurado como
punto de acceso de la red local del sistema, al que se conectan tanto los
cubos como el dispositivo del docente. Esta arquitectura de red local
cerrada evita dependencias de la conectividad del centro educativo y
