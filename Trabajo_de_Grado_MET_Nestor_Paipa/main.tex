...
\citep{ACACIA2025}. De ese proyecto se recibieron los diez
cubos ensamblados, la base ``Maestro'' y una primera versión
del backend y del frontend, capaz de enviar a un cubo una
señal individual de color, sin conexión todavía entre esa
interfaz y el hardware físico del tablero. A partir de esa
línea base, el aporte propio de la presente investigación
consiste en el diseño y la implementación del protocolo de
interacción Mago de Oz con el ciclo Pausar-Pensar-Actuar, la
arquitectura híbrida de dos canales (posición y actuación)
que conecta efectivamente la interfaz con el hardware, y la
adaptación completa del sistema al estudio del control
inhibitorio en un niño con TEA nivel 1 mediante EEG,
ninguno de los cuales forma parte de la entrega original del
proyecto ACACIA.
...
El diseño mecánico, electrónico y lógico de los cubos fue desarrollado por el módulo INNOVA del proyecto ACACIA (561754-EPP-1-2015-1-CO-EPPKA2-CBHE-JP), cofinanciado por el programa Erasmus+ y ejecutado conjuntamente por la Universidad NOVA de Lisboa y la Universidad Distrital Francisco José de Caldas \citep{ACACIA2025}. El hardware descrito a continuación —la base ``Maestro'', el ensamble en madera de cada cubo y sus componentes electrónicos internos— corresponde a esa entrega original; las secciones posteriores de este capítulo (arquitectura híbrida, protocolo Pausar-Pensar-Actuar, canal de posición y canal de actuación) describen la adaptación y el desarrollo propios de la presente investigación sobre esa base física.
...
El registro EEG continuo de cada ejercicio se procesa según el protocolo de potencia relativa alfa por tarea (Alpha TRP) descrito en la subsección «Generación de gráficas EEG». Sobre cada archivo de sesión se calcula la potencia en banda alfa (8-13 Hz) por canal, normalizada contra un intervalo de referencia inicial, y se construye un mapa topográfico de potencia relativa alfa por canal para cada ejercicio.
