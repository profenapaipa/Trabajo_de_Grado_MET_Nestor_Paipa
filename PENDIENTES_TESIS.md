...
| Revisar lenguaje de autonomía | 🟡 MEDIO | Fase 9 ya cerrada (dependencia satisfecha); mapeo de 5 ubicaciones hecho en una sesión anterior (líneas 2173, 2550, 2600, 2601, 2606) — **requiere reconfirmarse antes de ejecutar**, porque los números de línea pueden haberse desplazado tras las ediciones de las Fases 7 y 9; ninguna corregida todavía | Ninguna | Re-auditar números de línea vigentes al autorizar | Autorización (Fase 10) |
